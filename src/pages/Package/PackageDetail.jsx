    ...
    useEffect(() => {
        const fetchPackageDetail = async () => {
            ...
            try {
               ...
               toast.error('Failed to fetch package detail');
            } finally {
                setLoading(false);
            }
        };
        ...
        <div className="max-w-4xl mx-auto p-4">
            ...
            <div className="bg-white shadow-md rounded-lg p-6">
                <p className="text-gray-600 mb-2">
                    <strong>Giá:</strong> {new Intl.NumberFormat("vi-VN").format(packageDetail.price) + "đ"}
                </p>
                <p className="text-gray-600 mb-2">
                    <strong>Thời hạn:</strong> {packageDetail.duration} ngày
                </p>
                <p className="text-gray-600 mb-2">
                    <strong>Số lần sử dụng:</strong> {packageDetail.usesPerDur}
                </p>
                <p className="text-gray-600 mb-2">
